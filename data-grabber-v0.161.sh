...
export IPERF3_CLIENT='127.0.0.1'              # IPERF3_CLIENT ip address
export IPERF3_CLIENT_USER='iperf3'            # used to login to IPERF3_CLIENT
export IPERF3_SERVER='127.0.0.1'              # IPERF3_SERVER ip address
export IPERF3_SERVER_USER='iperf3'            # used to login to IPERF3_SERVER
...
if [[ $my_args  =~ -o[[:space:]]*\'(.*)\' ]] # escaping the right chars in bash can drive you crazy... :)
then
